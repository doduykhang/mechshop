...
public class JwtUtil {
	 private String SECRET_KEY = "super duper secrect key";
	    ...
	    public String generateToken(UserEntity user) {
	        ...
	        claims.put("validationToken", user.getValidationToken());
	        return createToken(claims, user.getUserName());
	    }
	    
	    public String extractValidationToken(String token) {
	        final Claims claims = extractAllClaims(token);
	        return (String)claims.get("validationToken");
	    }
